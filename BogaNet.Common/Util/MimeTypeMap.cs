...
/// </summary>
public abstract class MimeTypeMap //NUnit
{
   #region Variables

   private const string DEFAULT_TYPE = "text/html";
   private const string DEFAULT_EXT = "html";

   protected static readonly Lazy<IDictionary<string, string>> _mappings = new(buildMappings);
...
*/
      ...
      foreach (KeyValuePair<string, string> mapping in cache.Where(mapping => !mappings.ContainsKey(mapping.Value)))
      {
